...
test(Apartments, Types, OuterHallways, Elevator, GlobalConstraints):-
	...
	Landscapes = [0,1,0,1],
	Open = [0,1,0,0],
	input(Width, Height, Landscapes, Open, [apt_type(NumRooms, RoomTypes, RoomSizes, RoomWidths, RoomHeights)], [2], Apartments, Types, OuterHallways,Elevator,GlobalConstraints),
	plot(Apartments, P),
